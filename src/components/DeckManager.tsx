    ...
    <div className="space-y-5 sm:space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-3 sm:gap-4">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-zinc-900/80 backdrop-blur-xl p-4 sm:p-6 border border-zinc-800/80 shadow-xl"
        >
          {/* Subtle glow */}
          ...
          <div className="relative z-10 flex items-start justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <span className="text-[10px] sm:text-xs font-extrabold uppercase tracking-widest text-[#0071e3] flex items-center gap-1">
                  <Trophy size={12} className="text-amber-400 shrink-0" /> {"N\u00edvel"} {level}
                </span>
            ...
            <div className="text-right shrink-0">
              ...
              <span className="text-sm sm:text-lg font-black text-cyan-400 flex items-center justify-end gap-1">
                <Star size={13} className="fill-current text-amber-400" /> {xp}
              </span>
            </div>
          </div>
          ...
          <div className="relative z-10 mt-4 space-y-1">
            ...
            <div className="w-full h-2 sm:h-2.5 bg-zinc-800 rounded-full overflow-hidden border border-zinc-700/40">
              <motion.div
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-zinc-900/80 backdrop-blur-xl p-4 sm:p-6 border border-zinc-800/80 shadow-xl flex flex-col justify-between min-w-0 md:min-w-[200px]"
        >
          <div>
            ...
            <div className="mt-2 flex items-baseline gap-2">
              <span className="text-3xl sm:text-4xl font-black text-white tabular-nums">{streak}</span>
              <span className="text-xs font-bold text-amber-400/80">{"dias \uD83D\uDD25"}</span>
            </div>
          ...
          <button
            ...
            className="mt-3 w-full py-2 sm:py-2.5 bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 rounded-xl transition text-xs font-bold flex items-center justify-center gap-1.5 border border-amber-500/20 active:scale-95 touch-manipulation min-h-[40px]"
          >
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 p-5 sm:p-8 lg:p-10 text-white shadow-2xl shadow-[#0071e3]/15 border border-white/10"
      >
        {/* Ambient blurs */}
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-5 sm:gap-8">
          <div className="space-y-2 sm:space-y-3 max-w-2xl">
            ...
            <p className="text-blue-100/70 text-xs sm:text-sm font-normal leading-relaxed max-w-lg">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-5 pt-1 text-[10px] sm:text-xs font-semibold text-blue-200/80">
      ...
      {decks.length === 0 ? (
        ...
        >
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-3xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-4 text-3xl sm:text-4xl">
            {"\uD83D\uDCDA"}
          </div>
          <h3 className="text-lg sm:text-xl font-bold text-zinc-400 mb-1">Nenhum baralho ainda</h3>
          <p className="text-xs sm:text-sm text-zinc-600 max-w-xs">
          ...
          <AnimatePresence mode="popLayout">
            {decks.map((deck) => (
              <motion.div
                ...
                className="group relative bg-zinc-900/60 backdrop-blur-xl border border-zinc-800/80 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-lg flex flex-col justify-between transition-colors hover:border-[#0071e3]/30 hover:shadow-[0_8px_30px_rgba(0,113,227,0.08)]"
              >
                <div>
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <span className="text-xl sm:text-2xl p-2.5 sm:p-3 bg-zinc-800/60 rounded-xl sm:rounded-2xl border border-zinc-700/40">
                      {deck.icon}
                    </span>

                    <div className="flex items-center gap-1.5">
                      {deck.dueCardsCount > 0 && (
                        <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-emerald-500/10 text-emerald-400 text-[10px] sm:text-[11px] font-bold rounded-full border border-emerald-500/20">
                      ...
                      <button
                        ...
                        className="p-2 text-zinc-600 hover:text-rose-400 hover:bg-rose-500/10 rounded-xl transition min-w-[36px] min-h-[36px] flex items-center justify-center touch-manipulation"
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-[#0071e3] transition-colors leading-snug">
                    {deck.title}
                  </h3>
                ...
                {/* Action Buttons */}
                <div className="flex items-center gap-1.5 sm:gap-2 mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-zinc-800/50">
                  <Link
                    href={`/study/${deck.id}`}
                  ...
                  <a
                    ...
                    download
                    className="p-2.5 sm:p-3 bg-emerald-500/10 hover:bg-emerald-500 text-emerald-400 hover:text-white rounded-xl transition border border-emerald-500/20 flex items-center justify-center min-h-[44px] min-w-[44px] touch-manipulation"
                    title="Exportar .APKG"
                  >
                    <Download size={15} />
                  </a>
                  ...
                  <button
                    ...
                    className="p-2.5 sm:p-3 bg-zinc-800/80 hover:bg-zinc-700 text-zinc-300 rounded-xl transition border border-zinc-700/40 flex items-center justify-center min-h-[44px] min-w-[44px] touch-manipulation"
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-t-3xl sm:rounded-3xl p-5 sm:p-6 w-full sm:max-w-md shadow-2xl safe-bottom"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Mobile drag handle */}
              <div className="w-10 h-1 bg-zinc-700 rounded-full mx-auto mb-4 sm:hidden" />

              <h2 className="text-lg sm:text-xl font-bold text-white mb-4">Criar Novo Baralho</h2>
              <form onSubmit={handleCreateDeck} className="space-y-3 sm:space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded-xl border border-zinc-800 bg-zinc-800/50 text-white text-lg text-center font-medium focus:ring-2 focus:ring-[#0071e3] outline-none min-h-[48px]"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded-xl border border-zinc-800 bg-zinc-800/50 text-white font-medium focus:ring-2 focus:ring-[#0071e3] outline-none min-h-[48px]"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full p-3 rounded-xl border border-zinc-800 bg-zinc-800/50 text-white font-medium focus:ring-2 focus:ring-[#0071e3] outline-none resize-none"
                  />
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    type="button"
                    onClick={() => setIsModalOpen(false)}
                    className="flex-1 py-3 bg-zinc-800 text-white font-semibold rounded-xl hover:bg-zinc-700 transition min-h-[48px] touch-manipulation"
                  >
                    Cancelar
                  </button>
                  <button
        ...
        {isCardModalOpen && (
          ...
          >
            <motion.div
              ...
              exit={{ y: "100%", opacity: 0 }}
              transition={{ type: "spring", damping: 30, stiffness: 300 }}
              className="bg-zinc-900 border border-zinc-800 rounded-t-3xl sm:rounded-3xl p-5 sm:p-6 w-full sm:max-w-md shadow-2xl max-h-[90vh] overflow-y-auto safe-bottom"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Mobile drag handle */}
              <div className="w-10 h-1 bg-zinc-700 rounded-full mx-auto mb-4 sm:hidden" />
              ...
              <form onSubmit={handleCreateCard} className="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded-xl border border-zinc-800 bg-zinc-800/50 text-white font-medium focus:ring-2 focus:ring-[#0071e3] outline-none min-h-[48px] text-xs"
                  />
                </div>
                <div>
